...
export function getHomeArticles(){
  let action = {
    ...
    payload:axios.get(`http://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=${API_KEY}`)
  }
  return action
}
...
export default function newsReducer (state = initialState, action){
  ...
  switch (type) {
    case actionList.GET_HOME_ARTICLES:
      return {...state, homeArticlesArr: payload.articles}
